<script setup>
const showDeskMenu = ref(true);
</script>
<template>

  <dialog id="DeskMobile" class="h-auto w-11/12 md:w-1/2 p-5 text-white  bg-black rounded-md ">
    ...
    <div class="flex flex-col w-full h-auto ">
      ...
      <div class="flex w-full h-auto justify-center items-center">
        ...
        <div @click="!showDeskMenu" class="flex w-1/12 h-auto justify-center cursor-pointer">
          Close
        </div>
        <!--Header End-->
      </div>
