...
<template>
  <div class="bpi-items bg-gradient-to-r  h-100 flex flex-col justify-center items-center">
    <div class="card-best-practies rounded-lg shadow-lg p-8">
      ...
      <p class="feauters text-black ">
        Our team prides itself on providing a customer-first experience, ensuring that every step of the renovation process is tailored to meet your specific needs and preferences.
      </p>
